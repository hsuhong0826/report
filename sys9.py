...
def select_image():
    ...
    if file_path:
        ...
        attachment_label.config(text=f"附件數量: {len(attachment_paths)}", font=("標楷體", 12, "bold"))
...
def main():
    ...
    tk.Label(root, text="姓名：", font=("標楷體", 12)).grid(row=1, column=0, padx=(50, 10), pady=5, sticky=tk.W)
    name_entry = tk.Entry(root, width=40, font=("標楷體", 12))
    name_entry.grid(row=1, column=1, padx=(10, 50), pady=5)

    tk.Label(root, text="工號：", font=("標楷體", 12)).grid(row=2, column=0, padx=(50, 10), pady=5, sticky=tk.W)
    staff_id_entry = tk.Entry(root, width=40, font=("標楷體", 12))
    staff_id_entry.grid(row=2, column=1, padx=(10, 50), pady=5)

    tk.Label(root, text="信箱：", font=("標楷體", 12)).grid(row=3, column=0, padx=(50, 10), pady=5, sticky=tk.W)
    email_entry = tk.Entry(root, width=40, font=("標楷體", 12))
    email_entry.grid(row=3, column=1, padx=(10, 50), pady=5)

    tk.Label(root, text="電話(分機)：", font=("標楷體", 12)).grid(row=4, column=0, padx=(50, 10), pady=5, sticky=tk.W)
    phone_entry = tk.Entry(root, width=40, font=("標楷體", 12))
    phone_entry.grid(row=4, column=1, padx=(10, 50), pady=5)

    tk.Label(root, text="Anydesk號碼：", font=("標楷體", 12)).grid(row=5, column=0, padx=(50, 10), pady=5, sticky=tk.W)
    anydesk_entry = tk.Entry(root, width=40, font=("標楷體", 12))
    anydesk_entry.grid(row=5, column=1, padx=(10, 50), pady=5)

    tk.Label(root, text="問題描述：", font=("標楷體", 12)).grid(row=6, column=0, padx=(50, 10), pady=5, sticky=tk.W)
    ...
    tk.Button(root, text="畫面截圖", command=capture_screenshot, font=("標楷體", 12)).grid(
    ...
    attachment_label = tk.Label(root, text="未選擇附件", font=("標楷體", 12), anchor="w")
    attachment_label.grid(row=11, column=0, padx=50, pady=5, sticky=tk.W)

    submit_button = tk.Button(root, text="提交報修", command=submit_report, font=("標楷體", 14, "bold"))
    submit_button.grid(row=12, column=0, columnspan=2, pady=(20, 20))

    footer_label = tk.Label(root, text="Copyright by ZY-Info V1.0", font=("標楷體", 11, "bold"))
